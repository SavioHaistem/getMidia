...
function useFetch (userSearch=undefined, movieId=undefined, mediaType) {
  const mykey = `5c9f10225671a251a0d525e14cb03542`
  const [response, setResponse] = useState()
  const [Error, setError] = useState(null)

  userSearch ? useEffect(() => {
    axios.get(`https://api.themoviedb.org/3/search/multi?api_key=${mykey}&language=pt-BR&page=${1}&query=${userSearch}`)
